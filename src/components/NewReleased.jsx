...
const NewReleased = () => {
  return (
    <div className='relative md:h-[360px] h-[600px] sm:ml-7 ml-7'>
        ...
        <div className='mt-5'>
            <button className='absolute text-white left-[35%] flex text-sm border bg-gray-600 rounded-full p-2 hover:bg-gray-400 md:left-[48%]'>View More<AiOutlineArrowRight className='mt-1 ml-2' size={16}/></button>
        </div>
    </div>
  )
}
