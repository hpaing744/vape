...
import img7 from '../assets/disposable(1).webp'
...
const Disposable = () => {
  return (
    ...
    <div className='absolute bottom-[25%] text-white flex'>
        <img className='w-[80px] object-cover' src={img7} alt="" />
        <div>
        <p className='mt-5 text-xl font-bold mb-2'>Disposable</p>
        <p className='text-xs'>Easy,clean and superb flavour</p>
        </div>
    </div>
    </div>
