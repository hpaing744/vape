...
const Cards = () => {
  ...
  return (
    <div className='md:max-w-[1300px] m-auto mt-4 group w-full p-4 ml-2'>
        <div className='relative w-full h-[400px] bg-auto rounded-xl duration-300'  style={{backgroundImage:`url(${slides[currentIndex].url})`}}>
          <div className='bg-black/100 absolute lg:w-[730px] md:w-[480px] sm:w-[300px] w-[206px] h-[400px] md:left-[46%] left-[48%] rounded-xl'/>
          <div className='absolute text-white md:right-[20%] right-[5%] bottom-[30%] text-center ml-4'>
          ...
          <div className='absolute top-[50%] sm:right-5 right-[-5%] text-2xl rounded-full p-2 group-hover:bg-black/80 text-white cursor-pointer'>
