...
import img7 from '../assets/vape(7).jpg'

import {AiFillStar} from 'react-icons/ai'

const Devices = () => {
  return (
    <div className='md:max-w-[1320px] bg-black rounded-xl flex flex-col m-auto p-3 mt-4 ml-6'>
        ...
        <div className='absolute bottom-[25%] text-white flex'>
            ...
            <div>
            <p className='mt-5 font-bold text-xl mb-2'>Devices</p>
            <p className='text-xs'>Find the best for you here!</p>
            </div>
        </div>
        </div>
